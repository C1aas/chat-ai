...
export default function HallucinationWarning() {
  ...
  return countHallucination < 3 && !closedHallucination ? (
    <div className="w-[calc(100%-8px)] sticky select-none h-fit bg-gray-200 dark:bg-bg_dark p-2 px-3 rounded-lg flex justify-between items-center shadow-sm dark:shadow-dark">
